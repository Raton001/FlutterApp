...
import 'package:flutter_app/Subpages/teacher_answer_list.dart';
...
//    QuerySnapshot qn1 = await firestore.collection('documents').where('uid', isEqualTo: user.uid).getDocuments();
  ...
  navigateToDetail(DocumentSnapshot documentSnapshot) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => TeacherAnswerList(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore.collection('questions').where('image_url',isEqualTo: user.uid).snapshots(),
